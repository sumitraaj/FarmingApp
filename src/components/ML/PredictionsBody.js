...
const PredictionsBody=()=>{
    ...
    <div className={classes.column}>
      ...
      <div className={classes.card}>
          ...
          <div>
            <div className={classes.title}>Plant Disease</div>
            <div className={classes.text}>We provide instant and accurate result for disease suffered from plant. Get idea about plant disease using it's photo. </div>
          </div>
          <span className={classes.price}>No Cost</span>
          <Link to="/ImagePrediction"><button className={classes.button}>Get Started</button></Link>
      </div>
      </div>
    </div>
  </div>
